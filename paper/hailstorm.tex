...
%% TODO: Milind, we should probably talk about how we use Pipes+Pipes Concurrent 
%% to wire up processors. Additionally, maybe we can discuss how a user
%% specifies a bolt / typeclasses. Some of the details might fit better into the
%% Bolt section?
